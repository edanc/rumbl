defmodule Rumbl.VideoControllerTest do
  ...
  @tag login_as: "max"
  test "does not create video and redner errors when invalid", %{conn: conn, user: user} do
  ...
  @tag login_as: "max"
  test "authorizes actions against acccess by other users", %{conn: conn, user: owner} do
